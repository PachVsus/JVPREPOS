...
const pokemonInnerHTML = `
    <div class="front side">
            ...
            <img class="background" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png" alt="pokeball">
            <img class="image" src="${frontImg}" alt="${name}">
            </div>
            <span class="number" style="font-family: 'Comic Sans MS', cursive, sans-serif;">#${id}</span>
            <h3 class="name" style="font-family: 'Comic Sans MS', cursive, sans-serif;">${name}</h3>
            <div class="types">
                ${poke_types
                    .map(
                        (type) => `
    ...
    <div class="back side">
            ...
            <span class="number" style="font-family: 'Comic Sans MS', cursive, sans-serif;">#${id}</span>
    <div class="stats" style="font-family: 'Comic Sans MS', cursive, sans-serif;">
